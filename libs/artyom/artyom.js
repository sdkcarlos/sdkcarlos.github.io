...
(function (window) {'use strict';
    ...
    function Artyom() {
        ...
        var artyom_execute = function (voz) {
             ...
             * Example :
             * If you have a command with "Open Walmart" and "Open Willmar" is recognized, the open wallmart command will be triggered.
             * soundex("Open Walmart") == soundex("Open Willmar") <= true
             *
             */
