...
(function(window){'use strict';
    ...
    function ArtyomAI(){
            ...
            if(device.isMobile){
                ...
                artyom.say = function(message,action){
                    if(artyom.speechSupported()){
                        ...
                        MobileMessage.onend = function(event) {
            ...
            artyom.doInstruction = function(sentence){
                ...
                var a = artyom.execute(sentence);//Command founded object
                
                if(typeof(a) === "object"){
                    if(a.objeto){
                        if(a.objeto.smart){
                            a.objeto.action(a.indice,a.wildcard.item,a.wildcard.full);//Execute Smart command
                        }else{
                            a.objeto.action(a.indice);//Execute Normal command
                        }
